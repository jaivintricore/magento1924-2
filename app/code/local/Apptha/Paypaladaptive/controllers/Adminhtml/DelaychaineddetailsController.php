 ...
 *
 * */
class Apptha_Paypaladaptive_Adminhtml_DelaychaineddetailsController extends Mage_Adminhtml_Controller_action {
    /*
    ...
    protected function _initAction() {
        $this->loadLayout()
                ->_setActiveMenu('paypaladaptive/delaychaineddetails')
                ->_addBreadcrumb(Mage::helper('adminhtml')->__('Pending Delayed Chained Payment'), Mage::helper('adminhtml')->__('Pending Delayed Chained Payment'));

        $this->getLayout()->getBlock('head')->setTitle($this->__('Pending Delayed Chained Payment'));
    ...
    public function editAction() {
        $this->loadLayout();
        $this->_addContent($this->getLayout()->createBlock('paypaladaptive/adminhtml_delaychaineddetails_edit'));
        $this->renderLayout();
    }
